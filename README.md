...
2. Go to the "Code" tab, and replace [ALEXA_CLIENT_ID](/lambda/index.js#L12), [ALEXA_CLIENT_SECRET](/lambda/index.js#L13), and [SKILL_ID](/lambda/index.js#L14) with your own values on lines 12-14 in [index.js](/lambda/index.js#L11-L12).
